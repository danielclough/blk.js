...
const buildDocker = `docker build -t ${DockerHub.DockerHub}/blackcoin-more-ubase-${SYSTYPE}:${branch.branch} - --network=host < /home/daniel/git/blk.js/src/commands/install/moreBuilder/Dockerfile.ubase-${SYSTYPE}-${branch.branch}
# ubuntu (package with full ubuntu distro)
  docker build -t ${DockerHub.DockerHub}/blackcoin-more-ubuntu-${SYSTYPE}:${branch.branch} - --network=host < /home/daniel/git/blk.js/src/commands/install/moreBuilder/Dockerfile.ubuntu-${SYSTYPE}-${branch.branch}
...
docker cp ubase:/parts /home/daniel/git/blk.js/src/commands/install/moreBuilder
cd /home/daniel/git/blk.js/src/commands/install/moreBuilder
